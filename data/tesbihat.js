  ...
  turkish: {
    sabah: {
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            { type: 'prayer', text: 'Subhânallahi velhamdulillâhi ve lâilâhe illallahu vallahu ekber, ve lâhavle ve lâkuvvete illâ billâhil aliyyil azîm' },
            ...
            { type: 'repeat', count: 33, text: 'Subhanellah' },
            { type: 'repeat', count: 33, text: 'Elhamdulillah' },
            { type: 'repeat', count: 33, text: 'Allahuekber' }
          ]
        },
        {
          ...
          items: [
            ...
            { type: 'instruction', text: 'Duâ edilir.' },
            { type: 'instruction', text: 'Duâdan sonraki tesbihâta devam edilir:' },
            { type: 'repeat', count: 1, text: 'Fağlem ennehû' },
            { type: 'repeat', count: 33, text: 'Lâ ilâhe illallah' },
        ...
        },
        {
          ...
          items: [
            { type: 'instruction', text: 'Tesbihâttaki sâlât ü selâmlar okunur:' },
            ...
            { type: 'prayer', text: 'Allahumme salli alâ seyyidinâ Muhammedin ve alâ âli seyyidinâ Muhammed. Biadedi kulli dâin ve devâin ve bârik ve sellim aleyhi ve aleyhim tesliman kesîrâ.' },
            { type: 'prayer', text: 'Allahumme salli alâ seyyidinâ Muhammedin ve alâ âli seyyidinâ Muhammed. Biadedi kulli dâin ve devâin ve bârik ve sellim aleyhi ve aleyhim tesliman kesîrâ..' },
            { type: 'prayer', text: 'Allahumme salli alâ seyyidinâ Muhammedin ve alâ âli seyyidinâ Muhammed. Biadedi kulli dâin ve devâin ve bârik ve sellim aleyhi ve aleyhim tesliman kesirân kesîrâ.' }
          ]
        },
        {
          ...
          items: [
            ...
            { type: 'prayer', text: 'Elfu elfi salâtin ve elfu elfi selâmin aleyke yâ Resûlallah.' },
            { type: 'prayer', text: 'Elfu elfi salâtin ve elfu elfi selâmin aleyke yâ Habîballah.' },
            { type: 'prayer', text: 'Elfu elfi salâtin ve elfu elfi selâmin aleyke yâ emîne vahyillâh.' },
    ...
    ogle: {
      ...
      sections: [
        ...
        {
          title: 'Duâ-i İsm-i Âzam (Tablo)',
          items: [
            { type: 'instruction', text: 'DUÂ-İ İSM-İ ÂZAM okunur (Soldan sağa satır satır):' },
            { type: 'prayer', text: 'Bismillâhirrahmânirrahîm' },
            { type: 'table', rows: [
    ...
    ikindi: {
      ...
      sections: [
        ...
        { title: 'Salâten Tüncînâ + Tesbih', items: [
          { type: 'note', text: 'Sabah namazındaki ile aynı sıra takip edilir.' }
        ]},
        { title: 'Son - Nebe Sûresi', items: [
    ...
    aksam: {
      ...
      sections: [
        ...
        { title: 'Cümle-i Tevhid', items: [
          { type: 'repeat', count: 9, text: 'Lâ ilâhe illallahu vahdehû lâ şerike leh. Lehul mulku ve lehul hamdu yuhyî ve yumît. Vehuve hayyullezî lâyemut, biyedihil hayr ve huve alâ kulli şey\'in kadîr.' },
          { type: 'instruction', text: '10. defada eklenir: ve ileyhi\'l-mesîr' }
        ]},
        { title: 'İstiâze + Tesbih', items: [
          { type: 'note', text: 'Sabah namazındaki İstiâze duâları okunur.' }
        ]},
        { title: 'Son - Haşir Sûresi', items: [
          { type: 'instruction', text: 'Haşir Sûresi\'nin 20-24. Âyetleri okunur.' }
        ]}
      ]
    },
    ...
    yatsi: {
      ...
      sections: [
        ...
        { title: 'Salâten Tüncînâ', items: [
          { type: 'prayer', text: 'Allahumme salli alâ Seyyidinâ Muhammedin ve alâ âli seyyidinâ Muhammed. Salâten tuncina biha min cemîil ahvâli vel âfât...' },
          { type: 'instruction', text: 'Vitir namazını kılındıktan sonra tesbih yapılır.' }
        ]},
        { title: 'Tesbih + Salâvat', items: [
          { type: 'note', text: 'Öğle namazındaki gibi devam edilir.' }
        ]},
        { title: 'Son - Bakara 285-286', items: [
          { type: 'instruction', text: 'Bakara Sûresi\'nin 285-286. Âyetleri (Âmenerresûlü) okunarak namaz bitirilir:' },
          { type: 'prayer', text: 'Bismillâhirrahmânirrahîm, Âmene\'r-resûlu bimâ unzile ileyhi mir rabbihî ve\'l-mu\'minûn...' }
        ]}
      ]
    }
  },
