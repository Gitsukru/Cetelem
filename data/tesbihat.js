      ...
      sections: [
        ...
        SON_DUA_SABAH_IKINDI_SECTION,
        {
          ...
          items: [
            ...
            { type: 'verse', number: 1, text: 'Amme yetesaelune.' },
            { type: 'verse', number: 2, text: 'Aninnebeil\'azıymi.' },
            { type: 'verse', number: 3, text: 'Elleziy hum fiyhi muhtelifune.' },
            { type: 'verse', number: 4, text: 'Kella seya\'lemune.' },
            { type: 'verse', number: 5, text: 'Sümme kella seya\'lemune.' },
            { type: 'verse', number: 6, text: 'Elem nec\'alil\'arda mihaden.' },
            { type: 'verse', number: 7, text: 'Velcibale evtaden.' },
            { type: 'verse', number: 8, text: 'Ve halaknakum ezvacen.' },
            { type: 'verse', number: 9, text: 'Ve ce\'alna nevmekum subaten.' },
            { type: 'verse', number: 10, text: 'Ve ce\'alnelleyle libasen.' },
            { type: 'verse', number: 11, text: 'Ve ce\'alnennehare me\'aşen.' },
            { type: 'verse', number: 12, text: 'Ve beneyna fevkakum seb\'an şidaden.' },
            { type: 'verse', number: 13, text: 'Ve ce\'alna siracen vehhacen.' },
            { type: 'verse', number: 14, text: 'Ve enzelna minelmu\'sırati maen seccacen.' },
            { type: 'verse', number: 15, text: 'Linuhrice bihi habben ve nebaten.' },
            { type: 'verse', number: 16, text: 'Ve cennatin elfafen.' },
            { type: 'verse', number: 17, text: 'İnne yevmelfasli kane miykaten.' },
            { type: 'verse', number: 18, text: 'Yevme yunfehu fiyssuri fete\'tune efvacen.' },
            { type: 'verse', number: 19, text: 'Ve futihatissemau fekanet ebvaben.' },
            { type: 'verse', number: 20, text: 'Ve suyyiretilcibalu fekanet seraben.' },
            { type: 'verse', number: 21, text: 'İnne cehenneme kanet mirsaden' },
            { type: 'verse', number: 22, text: 'Littağıyne meaben.' },
            { type: 'verse', number: 23, text: 'Labisiyne fiyha ahkaben.' },
            { type: 'verse', number: 24, text: 'La yezukune fiyha berden ve la şeraben.' },
            { type: 'verse', number: 25, text: 'İlla hamiymen ve ğassakan.' },
            { type: 'verse', number: 26, text: 'Cezaen vifakan.' },
            { type: 'verse', number: 27, text: 'İnnehum kanu la yercune hısaben.' },
            { type: 'verse', number: 28, text: 'Ve kezzebu biayatina kizzaben.' },
            { type: 'verse', number: 29, text: 'Ve kulle şey\'in ahsaynahü kitaben.' },
            { type: 'verse', number: 30, text: 'Fezuku felen neziydekum illa \'azaben.' },
            { type: 'verse', number: 31, text: 'İnne lilmuttekıyne mefazen.' },
            { type: 'verse', number: 32, text: 'Hadaika ve a\'naben.' },
            { type: 'verse', number: 33, text: 'Ve keva\'ıbe etraben.' },
            { type: 'verse', number: 34, text: 'Ve ke\'sen dihakan.' },
            { type: 'verse', number: 35, text: 'La yesme\'une fiyha lağven ve la kizzaben.' },
            { type: 'verse', number: 36, text: 'Cezaen min rabbike \'ataen hısaben.' },
            { type: 'verse', number: 37, text: 'Rabbissemavati vel\'ardı ve ma beynehumerrahmani la yemlikune minhu hıtaben.' },
            { type: 'verse', number: 38, text: 'Yevme yekumurruhu velmelaiketu saffen la yetekellemune illa men ezine lehurrahmanu ve kale savaben.' },
            { type: 'verse', number: 39, text: 'Zalikelyevmulhakku femen şaettehaze ila rabbihi meaben.' },
            { type: 'verse', number: 40, text: 'İnna enzernakum \'azaben kariyben yevme yenzurulmer\'u ma kaddemet yedahu ve yekululkafiru ya leyteniy kuntu turaben.' }
          ]
        }
      ]
    },
